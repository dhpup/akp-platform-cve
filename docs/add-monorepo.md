...
add [akp-monorepo-cve](https://github.com/example-org/akp-monorepo-cve): application
...
1. **Fork [akp-monorepo-cve](https://github.com/example-org/akp-monorepo-cve)** (keep
...
2. **Trigger a first release**: change anything under `apps/rollouts-app/`,
   ...
   `ghcr.io/<you>/akp-monorepo-cve-rollouts-app:<run#>-<color>`.
...
4. **Point a pipeline at it.** Easiest: copy an existing app dir (e.g.
   ...
   - image:
       repoURL: ghcr.io/<you>/akp-monorepo-cve-rollouts-app
   ...
   - name: image
     value: ghcr.io/<you>/akp-monorepo-cve-rollouts-app
   ```
